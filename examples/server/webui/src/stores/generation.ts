...
export const useGenerationStore = defineStore('generation', () => {
  ...
  watch([prompt, negativePrompt, steps, cfgScale, sampler, width, height, theme, saveImages], (newValues) => {
  ...
  return { isLoading, imageUrl, error, generateImage, prompt, negativePrompt, steps, seed, cfgScale, sampler, samplers, width, height, isSidebarCollapsed, toggleSidebar, theme, toggleTheme, saveImages }
})
